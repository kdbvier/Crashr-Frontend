...
export const CustomInputStyle = styled.input<CustomInputStyleType>`
  ...
  width: 100%;
  color: ${(props) => props.colorMode ? (props.colorMode === 'light' ? '#767676' : '#b6b6b6') : '#767676'};
  ...
  background: ${(props) => props.colorMode ? (props.colorMode === 'light' ? (props.bgColor ? props.bgColor : '#cfcfcf') : '#4f4f4f') : '#cfcfcf'};
