...
export const CustomTextStyle = styled.div<CustomTextStyleType>`
  ...
  border-top-left-radius: ${(props) =>
    props.borderRadius ? props.borderRadius : props.borderTopLeftRadius};
  border-bottom-left-radius: ${(props) =>
    props.borderRadius ? props.borderRadius : props.borderBottomLeftRadius};
  border-top-right-radius: ${(props) =>
    props.borderRadius ? props.borderRadius : props.borderTopRightRadius};
  border-bottom-right-radius: ${(props) =>
    props.borderRadius ? props.borderRadius : props.borderBottomRightRadius};
  ...
  @media screen and (max-width: 768px) {
    ...
    max-width: ${(props) => props.smMaxWidth};
