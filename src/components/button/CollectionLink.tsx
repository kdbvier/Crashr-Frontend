...
import Link from 'next/link'; // Import Url type

interface CollectionLinkStyleType {
  className?: string;
  text?: string | number;
  gap?: string;
  color?: string;
  ...
  boxShadow?: string;
  smDisplay?: string;
  link?: any; // Ensure that link is of type Url
}

export const CollectionLinkStyle = styled(Link) <CollectionLinkStyleType>`
  /* white-space: nowrap; */
  overflow: hidden;
  ...
  color: ${(props) => props.color || '#F73737'};
...
const CollectionLink = ({
  ...
  return (
    <CollectionLinkStyle
      ...
      smPadding={smPadding}
      smDisplay={smDisplay}
      href={link} // Ensure that href is of type Url
    >
