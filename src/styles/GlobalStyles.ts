...
export const PageWrapper = styled.div<IPageWrapper>`
  ...
  background: ${props => props.colorMode === 'light' ? 'linear-gradient(180deg, #E7E7E7 0%, #E7E7E7 48.23%, rgba(247, 55, 55, 0.72) 96.4%)' : '#272727'};
...
export const CustomDatePicker = styled(DatePicker) <CustomDatePickerProps>`
